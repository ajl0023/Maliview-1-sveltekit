...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-62c484a9.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-62c484a9.js", assets + "/_app/chunks/vendor-0947166e.js"]
    },
    fetched: void 0,
    floc: false,
...
const metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-a913ad6c.js", "css": [], "js": ["layout.svelte-a913ad6c.js", "chunks/vendor-0947166e.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-6ed99ddc.js", "css": [], "js": ["error.svelte-6ed99ddc.js", "chunks/vendor-0947166e.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-0969fcc5.js", "css": ["assets/pages/index.svelte-08a4885a.css"], "js": ["pages/index.svelte-0969fcc5.js", "chunks/vendor-0947166e.js"], "styles": [] } };
...
const Modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"bu-modal " + escape($modal.visibility ? "bu-is-active" : "")}"><div class="${"bu-modal-background"}"></div>
	<div class="${"bu-modal-content"}"><div class="${"bu-image bu-is-4by3"}">${$modal.type === "video" && $modal.content ? `<div class="${"video-container svelte-1uwzqqj"}"><iframe height="${"100%"}" class="${"video-modal svelte-1uwzqqj"}" width="${"100%"}"${add_attribute("src", $modal.content.video_url, 0)} title="${"YouTube video player"}" frameborder="${"0"}" allow="${"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}" allowfullscreen></iframe></div>` : `${$modal.content ? `<img${add_attribute("src", $modal.content.url, 0)} alt="${""}" class="${"svelte-1uwzqqj"}">` : ``}`}</div></div>
...
async function load({ params, fetch: fetch2, session, stuff }) {
  ...
  const mobile = await fetch2("http://localhost:3000/api/mobile");
