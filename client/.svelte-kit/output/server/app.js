...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-bef58a0d.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-bef58a0d.js", assets + "/_app/chunks/vendor-b1544594.js"]
    },
    fetched: void 0,
    floc: false,
...
const css$l = {
  code: '.wrapper.svelte-15sj9qb.svelte-15sj9qb{width:100vw;position:fixed;z-index:3;pointer-events:none}.container.svelte-15sj9qb.svelte-15sj9qb{color:white;display:flex;justify-content:space-between;align-items:center;font-family:"Orator";padding:20px 40px;font-weight:100}.container.svelte-15sj9qb .left-container.svelte-15sj9qb{display:flex;pointer-events:all;align-items:center}.container.svelte-15sj9qb .logo-container.svelte-15sj9qb{max-width:10em;height:66px;pointer-events:all}.container.svelte-15sj9qb .logo-container img.svelte-15sj9qb{width:100%;object-fit:cover}@media(max-width: 650px){.secondary-main-trigger-icon.svelte-15sj9qb.svelte-15sj9qb{display:none}.logo.svelte-15sj9qb.svelte-15sj9qb{display:none}}.nav-menu-label.svelte-15sj9qb.svelte-15sj9qb{display:flex;align-items:center}.nav-menu-label.svelte-15sj9qb .secondary-main-trigger-icon.svelte-15sj9qb{font-size:18px;margin-left:9px;line-height:18px;cursor:pointer;line-height:20px;margin-top:-2px;margin-bottom:-1px;text-transform:uppercase;font-family:Orator;height:fit-content}',
...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="${"wrapper svelte-15sj9qb"}"><div class="${"container svelte-15sj9qb"}"><div class="${"left-container svelte-15sj9qb"}">${validate_component(Hamburger, "Hamburger").$$render($$result, {}, {}, {})}
      <div><label class="${"nav-menu-label svelte-15sj9qb"}" for="${"burger-trigger"}"><p class="${"secondary-main-trigger-icon svelte-15sj9qb"}">menu</p></label></div></div>

    <div class="${"logo-container svelte-15sj9qb"}"><a href="${"https://www.apeldesign.com/"}"><img class="${"logo svelte-15sj9qb"}" src="${"https://res.cloudinary.com/dt4xntymn/image/upload/v1631656727/misc/By_Apel_Design_White_hkfvc4.png"}" alt="${""}"></a></div></div>
</nav>`;
});
...
const CarouselRight = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"page"}"><div class="${"content-container svelte-7hr4yl"}"><div class="${"carousel-content-container svelte-7hr4yl"}"><div class="${"title-container svelte-7hr4yl"}"><h1 class="${"svelte-7hr4yl"}">ders</h1>
      ...
      <div class="${"carousel-container svelte-7hr4yl"}"><div class="${"indicator " + escape(page) + " svelte-7hr4yl"}">${``}</div>
        <div${add_attribute("data-glide-dir", `${$currentPage.page}`, 0)} class="${"glide right"}"${add_attribute("this", carousel, 0)}><div class="${"glide__track svelte-7hr4yl"}" data-glide-el="${"track"}"><ul class="${"glide__slides svelte-7hr4yl"}">${each(images$1.slice(14, 28), (img, i) => `<li class="${"glide__slide"}"><div class="${"slide-image-container svelte-7hr4yl"}"><img loading="${"lazy"}" class="${"carousel-image svelte-7hr4yl"}"${add_attribute("src", img, 0)} alt="${""}"></div>
                </li>`)}</ul></div></div>
...
const css$8 = {
  code: '.phase-label-container.svelte-1wic5dj.svelte-1wic5dj{color:white;display:flex;gap:10px;align-items:center;padding:0.5rem;font-family:Orator}.phase-label-container.svelte-1wic5dj h5.svelte-1wic5dj{width:fit-content;position:relative;cursor:pointer}.phase-label-container.svelte-1wic5dj .phase-label.svelte-1wic5dj::after{content:"";display:block;width:100%;height:1px;background-color:white}.overlay-image.svelte-1wic5dj.svelte-1wic5dj{position:relative;border:1px solid white}.overlay-image.svelte-1wic5dj.svelte-1wic5dj::before{z-index:2;content:"";height:100%;width:100%;position:absolute;display:block;background-color:rgba(0, 0, 0, 0.5)}.phase-2.svelte-1wic5dj.svelte-1wic5dj{display:grid;height:100%;grid-template-columns:repeat(25, 4%);grid-template-rows:repeat(25, 4%);width:100%;gap:2.8px}.phase-2.svelte-1wic5dj .grid-image-container.svelte-1wic5dj:nth-child(n+2):nth-child(-n+5){grid-column:span 10;grid-row:span 3}.phase-2.svelte-1wic5dj .grid-image-container.svelte-1wic5dj{grid-column:span 5;grid-row:span 4;overflow:hidden;width:100%}.phase-2.svelte-1wic5dj .grid-image-container.svelte-1wic5dj:nth-child(20){grid-column:span 5;grid-row:span 8}.phase-2.svelte-1wic5dj .grid-image-container.svelte-1wic5dj:nth-child(21){grid-column:span 5;grid-row:span 10}.phase-2.svelte-1wic5dj .grid-image-container.svelte-1wic5dj:nth-child(22){grid-row:span 12}.phase-2.svelte-1wic5dj .grid-image-container.svelte-1wic5dj:nth-child(8){grid-column:span 4;grid-row:span 4}.phase-2.svelte-1wic5dj .grid-image-container.svelte-1wic5dj:nth-child(18){grid-column:span 10;grid-row:span 6}.phase-2.svelte-1wic5dj .grid-image-container.svelte-1wic5dj:nth-child(10){grid-column:span 6}.phase-1.svelte-1wic5dj.svelte-1wic5dj{display:grid;height:100%;grid-template-columns:repeat(10, 1fr);grid-template-rows:repeat(20, minmax(calc(100% / 4), 1fr));gap:5px}.phase-1.svelte-1wic5dj .grid-image-container.svelte-1wic5dj:nth-child(n+2):nth-child(-n+5){grid-column:span 1;grid-row:span 1}.phase-1.svelte-1wic5dj .grid-image-container.svelte-1wic5dj:nth-child(8){grid-column:span 4;grid-row:span 1}.phase-1.svelte-1wic5dj .grid-image-container.svelte-1wic5dj:nth-child(12){grid-column:span 4;grid-row:span 1}.phase-1.svelte-1wic5dj .grid-image-container.svelte-1wic5dj{grid-column:span 3;grid-row:span 1;overflow:hidden;width:100%}.grid-container.svelte-1wic5dj img.svelte-1wic5dj{object-fit:cover}.grid-container.svelte-1wic5dj iframe.svelte-1wic5dj{grid-column-end:span 7;height:100%}.overlay-image.svelte-1wic5dj.svelte-1wic5dj{position:relative}.overlay-image.svelte-1wic5dj.svelte-1wic5dj::before{z-index:2;content:"";height:100%;width:100%;position:absolute;display:block;background-color:rgba(0, 0, 0, 0.5)}img.svelte-1wic5dj.svelte-1wic5dj{cursor:pointer;width:100%;height:100%}',
  map: `{"version":3,"file":"Gallery.svelte","sources":["Gallery.svelte"],"sourcesContent":["\uFEFF<script>\\r\\n  import { galleryImg } from \\"../GalleryPreview/store\\";\\r\\n  import GalleryImage from \\"../GalleryImage/GalleryImage.svelte\\";\\r\\n  import { images } from \\"./galleryImages\\";\\r\\n  let selected;\\r\\n\\r\\n  const phases = [\\"phase 1\\", \\"phase 2\\"];\\r\\n\\r\\n  const selectImage = (i) => {\\r\\n    galleryImg.update((s) => {\\r\\n      s.index = i;\\r\\n      return s;\\r\\n    });\\r\\n  };\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"page\\">\\r\\n  <div class=\\"phase-label-container\\">\\r\\n    {#each phases as phase}\\r\\n      <h5\\r\\n        on:click={() => {\\r\\n          galleryImg.update((s) => {\\r\\n            s.currPhase = phase;\\r\\n            return s;\\r\\n          });\\r\\n        }}\\r\\n        class:phase-label={phase === $galleryImg.currPhase}\\r\\n      >\\r\\n        {phase}\\r\\n      </h5>\\r\\n    {/each}\\r\\n  </div>\\r\\n  <div class=\\"grid-container {$galleryImg.currPhase.replace(' ', '-')}\\">\\r\\n    {#each images[$galleryImg.currPhase] as img, i}\\r\\n      <svelte:component this={GalleryImage}>\\r\\n        <div\\r\\n          class=\\"grid-image-container {$galleryImg.index === i\\r\\n            ? 'overlay-image'\\r\\n            : ''}\\"\\r\\n          index={i}\\r\\n        >\\r\\n          <img\\r\\n            on:click={() => {\\r\\n              selectImage(i);\\r\\n            }}\\r\\n            loading=\\"lazy\\"\\r\\n            src={img}\\r\\n            alt=\\"\\"\\r\\n          />\\r\\n        </div>\\r\\n      </svelte:component>\\r\\n    {/each}\\r\\n    {#if $galleryImg.currPhase === \\"phase 1\\"}\\r\\n      <iframe\\r\\n        class=\\"video-modal\\"\\r\\n        width=\\"100%\\"\\r\\n        src=\\"https://www.youtube.com/embed/nTS10ZQM5Ms\\"\\r\\n        title=\\"YouTube video player\\"\\r\\n        allow=\\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\\"\\r\\n      />\\r\\n    {/if}\\r\\n  </div>\\r\\n</div>\\r\\n\\r\\n<style lang=\\"scss\\">.phase-label-container {\\n  color: white;\\n  display: flex;\\n  gap: 10px;\\n  align-items: center;\\n  padding: 0.5rem;\\n  font-family: Orator;\\n}\\n.phase-label-container h5 {\\n  width: fit-content;\\n  position: relative;\\n  cursor: pointer;\\n}\\n.phase-label-container .phase-label::after {\\n  content: \\"\\";\\n  display: block;\\n  width: 100%;\\n  height: 1px;\\n  background-color: white;\\n}\\n\\n.overlay-image {\\n  position: relative;\\n  border: 1px solid white;\\n}\\n.overlay-image::before {\\n  z-index: 2;\\n  content: \\"\\";\\n  height: 100%;\\n  width: 100%;\\n  position: absolute;\\n  display: block;\\n  background-color: rgba(0, 0, 0, 0.5);\\n}\\n\\n.phase-2 {\\n  display: grid;\\n  height: 100%;\\n  grid-template-columns: repeat(25, 4%);\\n  grid-template-rows: repeat(25, 4%);\\n  width: 100%;\\n  gap: 2.8px;\\n}\\n.phase-2 .grid-image-container:nth-child(n+2):nth-child(-n+5) {\\n  grid-column: span 10;\\n  grid-row: span 3;\\n}\\n.phase-2 .grid-image-container {\\n  grid-column: span 5;\\n  grid-row: span 4;\\n  overflow: hidden;\\n  width: 100%;\\n}\\n.phase-2 .grid-image-container:nth-child(20) {\\n  grid-column: span 5;\\n  grid-row: span 8;\\n}\\n.phase-2 .grid-image-container:nth-child(21) {\\n  grid-column: span 5;\\n  grid-row: span 10;\\n}\\n.phase-2 .grid-image-container:nth-child(22) {\\n  grid-row: span 12;\\n}\\n.phase-2 .grid-image-container:nth-child(8) {\\n  grid-column: span 4;\\n  grid-row: span 4;\\n}\\n.phase-2 .grid-image-container:nth-child(18) {\\n  grid-column: span 10;\\n  grid-row: span 6;\\n}\\n.phase-2 .grid-image-container:nth-child(10) {\\n  grid-column: span 6;\\n}\\n\\n.phase-1 {\\n  display: grid;\\n  height: 100%;\\n  grid-template-columns: repeat(10, 1fr);\\n  grid-template-rows: repeat(20, minmax(calc(100% / 4), 1fr));\\n  gap: 5px;\\n}\\n.phase-1 .grid-image-container:nth-child(n+2):nth-child(-n+5) {\\n  grid-column: span 1;\\n  grid-row: span 1;\\n}\\n.phase-1 .grid-image-container:nth-child(8) {\\n  grid-column: span 4;\\n  grid-row: span 1;\\n}\\n.phase-1 .grid-image-container:nth-child(12) {\\n  grid-column: span 4;\\n  grid-row: span 1;\\n}\\n.phase-1 .grid-image-container {\\n  grid-column: span 3;\\n  grid-row: span 1;\\n  overflow: hidden;\\n  width: 100%;\\n}\\n\\n.grid-container img {\\n  object-fit: cover;\\n}\\n.grid-container iframe {\\n  grid-column-end: span 7;\\n  height: 100%;\\n}\\n\\n.overlay-image {\\n  position: relative;\\n}\\n.overlay-image::before {\\n  z-index: 2;\\n  content: \\"\\";\\n  height: 100%;\\n  width: 100%;\\n  position: absolute;\\n  display: block;\\n  background-color: rgba(0, 0, 0, 0.5);\\n}\\n\\nimg {\\n  cursor: pointer;\\n  width: 100%;\\n  height: 100%;\\n}</style>\\r\\n"],"names":[],"mappings":"AAgEmB,sBAAsB,8BAAC,CAAC,AACzC,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,IAAI,CACb,GAAG,CAAE,IAAI,CACT,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,MAAM,CACf,WAAW,CAAE,MAAM,AACrB,CAAC,AACD,qCAAsB,CAAC,EAAE,eAAC,CAAC,AACzB,KAAK,CAAE,WAAW,CAClB,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,OAAO,AACjB,CAAC,AACD,qCAAsB,CAAC,2BAAY,OAAO,AAAC,CAAC,AAC1C,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,gBAAgB,CAAE,KAAK,AACzB,CAAC,AAED,cAAc,8BAAC,CAAC,AACd,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,AACzB,CAAC,AACD,4CAAc,QAAQ,AAAC,CAAC,AACtB,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,EAAE,CACX,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,KAAK,CACd,gBAAgB,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACtC,CAAC,AAED,QAAQ,8BAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,qBAAqB,CAAE,OAAO,EAAE,CAAC,CAAC,EAAE,CAAC,CACrC,kBAAkB,CAAE,OAAO,EAAE,CAAC,CAAC,EAAE,CAAC,CAClC,KAAK,CAAE,IAAI,CACX,GAAG,CAAE,KAAK,AACZ,CAAC,AACD,uBAAQ,CAAC,oCAAqB,WAAW,GAAG,CAAC,WAAW,IAAI,CAAC,AAAC,CAAC,AAC7D,WAAW,CAAE,IAAI,CAAC,EAAE,CACpB,QAAQ,CAAE,IAAI,CAAC,CAAC,AAClB,CAAC,AACD,uBAAQ,CAAC,qBAAqB,eAAC,CAAC,AAC9B,WAAW,CAAE,IAAI,CAAC,CAAC,CACnB,QAAQ,CAAE,IAAI,CAAC,CAAC,CAChB,QAAQ,CAAE,MAAM,CAChB,KAAK,CAAE,IAAI,AACb,CAAC,AACD,uBAAQ,CAAC,oCAAqB,WAAW,EAAE,CAAC,AAAC,CAAC,AAC5C,WAAW,CAAE,IAAI,CAAC,CAAC,CACnB,QAAQ,CAAE,IAAI,CAAC,CAAC,AAClB,CAAC,AACD,uBAAQ,CAAC,oCAAqB,WAAW,EAAE,CAAC,AAAC,CAAC,AAC5C,WAAW,CAAE,IAAI,CAAC,CAAC,CACnB,QAAQ,CAAE,IAAI,CAAC,EAAE,AACnB,CAAC,AACD,uBAAQ,CAAC,oCAAqB,WAAW,EAAE,CAAC,AAAC,CAAC,AAC5C,QAAQ,CAAE,IAAI,CAAC,EAAE,AACnB,CAAC,AACD,uBAAQ,CAAC,oCAAqB,WAAW,CAAC,CAAC,AAAC,CAAC,AAC3C,WAAW,CAAE,IAAI,CAAC,CAAC,CACnB,QAAQ,CAAE,IAAI,CAAC,CAAC,AAClB,CAAC,AACD,uBAAQ,CAAC,oCAAqB,WAAW,EAAE,CAAC,AAAC,CAAC,AAC5C,WAAW,CAAE,IAAI,CAAC,EAAE,CACpB,QAAQ,CAAE,IAAI,CAAC,CAAC,AAClB,CAAC,AACD,uBAAQ,CAAC,oCAAqB,WAAW,EAAE,CAAC,AAAC,CAAC,AAC5C,WAAW,CAAE,IAAI,CAAC,CAAC,AACrB,CAAC,AAED,QAAQ,8BAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,qBAAqB,CAAE,OAAO,EAAE,CAAC,CAAC,GAAG,CAAC,CACtC,kBAAkB,CAAE,OAAO,EAAE,CAAC,CAAC,OAAO,KAAK,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAC3D,GAAG,CAAE,GAAG,AACV,CAAC,AACD,uBAAQ,CAAC,oCAAqB,WAAW,GAAG,CAAC,WAAW,IAAI,CAAC,AAAC,CAAC,AAC7D,WAAW,CAAE,IAAI,CAAC,CAAC,CACnB,QAAQ,CAAE,IAAI,CAAC,CAAC,AAClB,CAAC,AACD,uBAAQ,CAAC,oCAAqB,WAAW,CAAC,CAAC,AAAC,CAAC,AAC3C,WAAW,CAAE,IAAI,CAAC,CAAC,CACnB,QAAQ,CAAE,IAAI,CAAC,CAAC,AAClB,CAAC,AACD,uBAAQ,CAAC,oCAAqB,WAAW,EAAE,CAAC,AAAC,CAAC,AAC5C,WAAW,CAAE,IAAI,CAAC,CAAC,CACnB,QAAQ,CAAE,IAAI,CAAC,CAAC,AAClB,CAAC,AACD,uBAAQ,CAAC,qBAAqB,eAAC,CAAC,AAC9B,WAAW,CAAE,IAAI,CAAC,CAAC,CACnB,QAAQ,CAAE,IAAI,CAAC,CAAC,CAChB,QAAQ,CAAE,MAAM,CAChB,KAAK,CAAE,IAAI,AACb,CAAC,AAED,8BAAe,CAAC,GAAG,eAAC,CAAC,AACnB,UAAU,CAAE,KAAK,AACnB,CAAC,AACD,8BAAe,CAAC,MAAM,eAAC,CAAC,AACtB,eAAe,CAAE,IAAI,CAAC,CAAC,CACvB,MAAM,CAAE,IAAI,AACd,CAAC,AAED,cAAc,8BAAC,CAAC,AACd,QAAQ,CAAE,QAAQ,AACpB,CAAC,AACD,4CAAc,QAAQ,AAAC,CAAC,AACtB,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,EAAE,CACX,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,KAAK,CACd,gBAAgB,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACtC,CAAC,AAED,GAAG,8BAAC,CAAC,AACH,MAAM,CAAE,OAAO,CACf,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACd,CAAC"}`
};
const Gallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_galleryImg();
  return `<div class="${"page"}"><div class="${"phase-label-container svelte-1wic5dj"}">${each(phases, (phase) => `<h5 class="${["svelte-1wic5dj", phase === $galleryImg.currPhase ? "phase-label" : ""].join(" ").trim()}">${escape(phase)}
      </h5>`)}</div>
  <div class="${"grid-container " + escape($galleryImg.currPhase.replace(" ", "-")) + " svelte-1wic5dj"}">${each(images[$galleryImg.currPhase], (img, i) => `${validate_component(GalleryImage || missing_component, "svelte:component").$$render($$result, {}, {}, {
    default: () => `<div class="${"grid-image-container " + escape($galleryImg.index === i ? "overlay-image" : "") + " svelte-1wic5dj"}"${add_attribute("index", i, 0)}><img loading="${"lazy"}"${add_attribute("src", img, 0)} alt="${""}" class="${"svelte-1wic5dj"}"></div>
      `
  })}`)}
    ${$galleryImg.currPhase === "phase 1" ? `<iframe class="${"video-modal svelte-1wic5dj"}" width="${"100%"}" src="${"https://www.youtube.com/embed/nTS10ZQM5Ms"}" title="${"YouTube video player"}" allow="${"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}"></iframe>` : ``}</div>
</div>`;
});
...
const CardCarousel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div${add_attribute("id", navToLink[index2 + 2], 0)} class="${"bu-card card-container svelte-5u8hvp"}"><div class="${"carousel-container svelte-5u8hvp"}"><div class="${"glide"}"${add_attribute("this", carousel, 0)}><div class="${"indicator svelte-5u8hvp"}">${``}</div>
      <div class="${"glide__track"}" data-glide-el="${"track"}"><ul class="${"glide__slides"}"${add_attribute("this", slider, 0)}>${each(images2[page.title], (img, i) => `<li style="${"width:" + escape("") + "px"}" class="${"glide__slide"}"${add_attribute("this", glideContainer, 0)}><div class="${"glide-image-container svelte-5u8hvp"}">${validate_component(PinchZoom, "PinchZoom").$$render($$result, { img }, {}, {})}</div>
            </li>`)}</ul></div>
      <div class="${"glide__arrows"}" data-glide-el="${"controls"}"><button class="${"glide__arrow page-arrow-container glide__arrow--left arrow-left svelte-5u8hvp"}"><div class="${"page-arrow-relative svelte-5u8hvp"}">${validate_component(Arrow, "Arrow").$$render($$result, {
    styleP: "object-fit:cover;width:100%;fill:white; transform:rotate(-90deg); height:100%; "
  }, {}, {})}</div></button>
        <button class="${"glide__arrow page-arrow-container glide__arrow--right arrow-right svelte-5u8hvp"}"><div class="${"page-arrow-relative svelte-5u8hvp"}">${validate_component(Arrow, "Arrow").$$render($$result, {
    styleP: "object-fit:cover;width:100%;fill:white; transform:rotate(-90deg); height:100%; "
  }, {}, {})}</div></button></div></div></div>
  <div class="${"card-content bu-card-content svelte-5u8hvp"}"><div class="${"bu-media"}"><div class="${"bu-media-left"}"><figure class="${"bu-image bu-is-48x48"}"><div class="${"square-place-holder svelte-5u8hvp"}" style="${"height: 100%; width:100%;"}"><img src="${"https://res.cloudinary.com/dt4xntymn/image/upload/v1631671006/misc/Maliview_cswlog.png"}" alt="${""}" class="${"svelte-5u8hvp"}"></div></figure></div>
      ${textPages[index2] ? `<h5 class="${"title is-4 font-white svelte-5u8hvp"}">${escape(textPages[index2].header)}</h5>` : ``}</div>
    <div class="${"content bu-is-clipped content font-white " + escape("") + " svelte-5u8hvp"}"${add_attribute("this", mainText, 0)}>${textPages[index2] ? `${each(textPages[index2].paragraphs, (p) => `<p>${escape(p)}</p>`)}` : ``}</div>
    <br>
    ${``}</div>
</div>`;
});
