...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-7463b951.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-7463b951.js", assets + "/_app/chunks/vendor-f4af72fe.js"]
    },
    fetched: void 0,
    floc: false,
...
const metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-efa6928d.js", "css": [], "js": ["layout.svelte-efa6928d.js", "chunks/vendor-f4af72fe.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-035085c8.js", "css": [], "js": ["error.svelte-035085c8.js", "chunks/vendor-f4af72fe.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-d93ca071.js", "css": ["assets/pages/index.svelte-28d400f2.css"], "js": ["pages/index.svelte-d93ca071.js", "chunks/vendor-f4af72fe.js"], "styles": [] } };
...
const Hamburger = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div><input type="${"checkbox"}" id="${"burger-trigger"}" class="${"burger-input svelte-195y347"}"${add_attribute("this", mainInput, 0)}>
  <label for="${"burger-trigger"}" class="${"burger-label svelte-195y347"}"><span class="${"main-trigger-icon-container svelte-195y347"}"><i class="${"main-trigger-icon svelte-195y347"}"></i></span></label>
  <div class="${"side-menu-container svelte-195y347"}"><ul name="${"list-container"}" class="${"side-menu-item-container svelte-195y347"}">${each(navButtons, (label, i) => `<li class="${"svelte-195y347"}">${escape(label)}
        </li>`)}</ul>
    <div class="${"sidebar-logo-container svelte-195y347"}"><a href="${"https://www.apeldesign.com/"}"><img src="${"https://res.cloudinary.com/dt4xntymn/image/upload/v1631656727/misc/By_Apel_Design_Black_z0yd9b.png"}" alt="${""}" class="${"svelte-195y347"}"></a></div></div>

  <div data-id="${"header-mask"}" class="${"header-mask svelte-195y347"}"></div>
</div>`;
});
var Navbar_svelte_svelte_type_style_lang = "";
const css$k = {
  code: '.wrapper.svelte-jcguzc.svelte-jcguzc{width:100vw;position:fixed;z-index:4}.container.svelte-jcguzc.svelte-jcguzc{color:white;display:flex;justify-content:space-between;align-items:center;font-family:"Orator";padding:20px 40px;font-weight:100}.container.svelte-jcguzc .left-container.svelte-jcguzc{display:flex;align-items:center}.container.svelte-jcguzc .logo-container.svelte-jcguzc{max-width:10em;height:66px}.container.svelte-jcguzc .logo-container img.svelte-jcguzc{width:100%;object-fit:cover}@media(max-width: 650px){.secondary-main-trigger-icon.svelte-jcguzc.svelte-jcguzc{display:none}.logo.svelte-jcguzc.svelte-jcguzc{display:none}}.nav-menu-label.svelte-jcguzc.svelte-jcguzc{display:flex;align-items:center}.nav-menu-label.svelte-jcguzc .secondary-main-trigger-icon.svelte-jcguzc{font-size:18px;margin-left:9px;line-height:18px;cursor:pointer;line-height:20px;margin-top:-2px;margin-bottom:-1px;text-transform:uppercase;font-family:Orator;height:fit-content}',
  map: '{"version":3,"file":"Navbar.svelte","sources":["Navbar.svelte"],"sourcesContent":["\uFEFF<script>\\r\\n  import Hamburger from \\"../Hamburger/Hamburger.svelte\\";\\r\\n<\/script>\\r\\n\\r\\n<nav class=\\"wrapper\\">\\r\\n  <div class=\\"container\\">\\r\\n    <div class=\\"left-container\\">\\r\\n      <Hamburger />\\r\\n      <div>\\r\\n        <label class=\\"nav-menu-label\\" for=\\"burger-trigger\\">\\r\\n          <p class=\\"secondary-main-trigger-icon\\">menu</p>\\r\\n        </label>\\r\\n      </div>\\r\\n    </div>\\r\\n\\r\\n    <div class=\\"logo-container\\">\\r\\n      <a\\r\\n        on:click={(e) => {\\r\\n          e.preventDefault();\\r\\n          window.open(\\"https://www.apeldesign.com/\\");\\r\\n        }}\\r\\n        href=\\"https://www.apeldesign.com/\\"\\r\\n      >\\r\\n        <img\\r\\n          class=\\"logo\\"\\r\\n          src=\\"https://res.cloudinary.com/dt4xntymn/image/upload/v1631656727/misc/By_Apel_Design_White_hkfvc4.png\\"\\r\\n          alt=\\"\\"\\r\\n        />\\r\\n      </a>\\r\\n    </div>\\r\\n  </div>\\r\\n</nav>\\r\\n\\r\\n<style lang=\\"scss\\">.wrapper {\\n  width: 100vw;\\n  position: fixed;\\n  z-index: 4;\\n}\\n\\n.container {\\n  color: white;\\n  display: flex;\\n  justify-content: space-between;\\n  align-items: center;\\n  font-family: \\"Orator\\";\\n  padding: 20px 40px;\\n  font-weight: 100;\\n}\\n.container .left-container {\\n  display: flex;\\n  align-items: center;\\n}\\n.container .logo-container {\\n  max-width: 10em;\\n  height: 66px;\\n}\\n.container .logo-container img {\\n  width: 100%;\\n  object-fit: cover;\\n}\\n\\n@media (max-width: 650px) {\\n  .secondary-main-trigger-icon {\\n    display: none;\\n  }\\n\\n  .logo {\\n    display: none;\\n  }\\n}\\n.nav-menu-label {\\n  display: flex;\\n  align-items: center;\\n}\\n.nav-menu-label .secondary-main-trigger-icon {\\n  font-size: 18px;\\n  margin-left: 9px;\\n  line-height: 18px;\\n  cursor: pointer;\\n  line-height: 20px;\\n  margin-top: -2px;\\n  margin-bottom: -1px;\\n  text-transform: uppercase;\\n  font-family: Orator;\\n  height: fit-content;\\n}</style>\\r\\n"],"names":[],"mappings":"AAiCmB,QAAQ,4BAAC,CAAC,AAC3B,KAAK,CAAE,KAAK,CACZ,QAAQ,CAAE,KAAK,CACf,OAAO,CAAE,CAAC,AACZ,CAAC,AAED,UAAU,4BAAC,CAAC,AACV,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,WAAW,CAAE,QAAQ,CACrB,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,WAAW,CAAE,GAAG,AAClB,CAAC,AACD,wBAAU,CAAC,eAAe,cAAC,CAAC,AAC1B,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,AACrB,CAAC,AACD,wBAAU,CAAC,eAAe,cAAC,CAAC,AAC1B,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,IAAI,AACd,CAAC,AACD,wBAAU,CAAC,eAAe,CAAC,GAAG,cAAC,CAAC,AAC9B,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,KAAK,AACnB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,4BAA4B,4BAAC,CAAC,AAC5B,OAAO,CAAE,IAAI,AACf,CAAC,AAED,KAAK,4BAAC,CAAC,AACL,OAAO,CAAE,IAAI,AACf,CAAC,AACH,CAAC,AACD,eAAe,4BAAC,CAAC,AACf,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,AACrB,CAAC,AACD,6BAAe,CAAC,4BAA4B,cAAC,CAAC,AAC5C,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,WAAW,CAAE,IAAI,CACjB,MAAM,CAAE,OAAO,CACf,WAAW,CAAE,IAAI,CACjB,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,IAAI,CACnB,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,MAAM,CACnB,MAAM,CAAE,WAAW,AACrB,CAAC"}'
};
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$k);
  return `<nav class="${"wrapper svelte-jcguzc"}"><div class="${"container svelte-jcguzc"}"><div class="${"left-container svelte-jcguzc"}">${validate_component(Hamburger, "Hamburger").$$render($$result, {}, {}, {})}
      <div><label class="${"nav-menu-label svelte-jcguzc"}" for="${"burger-trigger"}"><p class="${"secondary-main-trigger-icon svelte-jcguzc"}">menu</p></label></div></div>

    <div class="${"logo-container svelte-jcguzc"}"><a href="${"https://www.apeldesign.com/"}"><img class="${"logo svelte-jcguzc"}" src="${"https://res.cloudinary.com/dt4xntymn/image/upload/v1631656727/misc/By_Apel_Design_White_hkfvc4.png"}" alt="${""}"></a></div></div>
</nav>`;
});
...
const css$g = {
  code: ".title-container.svelte-k9el90.svelte-k9el90{text-align:right;color:white;padding:20px 0 20px 20px}.title-container.svelte-k9el90 h1.svelte-k9el90{font-size:3em;text-transform:uppercase;font-family:Orator;color:white}.content-container.svelte-k9el90.svelte-k9el90{display:flex;height:100%;padding:10px 0 10px 30px;overflow:hidden;flex-direction:column;align-items:flex-end;justify-content:center}.carousel-content-container.svelte-k9el90.svelte-k9el90{max-width:500px;width:100%;height:100%;align-items:flex-end;display:flex;flex-direction:column;justify-content:center}.slide-image-container.svelte-k9el90.svelte-k9el90{position:relative;width:100%;height:100%}.slide-image-container.svelte-k9el90 img.svelte-k9el90{position:absolute;height:100%;width:100%}.glide__track.svelte-k9el90.svelte-k9el90{height:100%}.page-arrow-container.svelte-k9el90.svelte-k9el90{width:30px;height:30px;position:absolute;left:10px;bottom:0;top:50%;border-radius:50%;background-color:rgba(0, 0, 0, 0.5);border:none;overflow:hidden}.page-arrow-container.svelte-k9el90 .page-arrow-relative.svelte-k9el90{position:absolute;top:0;left:0;bottom:0;right:0;padding:5px;margin:auto}.glide__slides.svelte-k9el90.svelte-k9el90{height:100%}.carousel-container.svelte-k9el90.svelte-k9el90{width:100%;height:65%;display:flex;position:relative}",
  map: '{"version":3,"file":"CarouselLeft.svelte","sources":["CarouselLeft.svelte"],"sourcesContent":["\uFEFF<script>\\r\\n  import Glide from \\"@glidejs/glide\\";\\r\\n  import { afterUpdate, onMount } from \\"svelte\\";\\r\\n  import { currentPage } from \\"../../stores\\";\\r\\n  import CarouselThumbs from \\"../CarouselThumbs/CarouselThumbs.svelte\\";\\r\\n  import { images } from \\"../image\\";\\r\\n  import Arrow from \\"../Card/Arrow.svelte\\";\\r\\n  let carousel;\\r\\n  let glide;\\r\\n  \\r\\n\\r\\n  onMount(() => {\\r\\n    glide = new Glide(carousel, {\\r\\n      dragThreshold: false,\\r\\n    });\\r\\n    glide.mount();\\r\\n  });\\r\\n  afterUpdate(() => {\\r\\n    glide.go(`=${$currentPage.page}`);\\r\\n  });\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"page\\">\\r\\n  <div class=\\"content-container\\">\\r\\n    <div class=\\"carousel-content-container\\">\\r\\n      <div class=\\"title-container\\">\\r\\n        <h1>ren</h1>\\r\\n        <p>Browse below for interior and ext</p>\\r\\n      </div>\\r\\n      <div class=\\"carousel-container\\">\\r\\n        <div\\r\\n          bind:this={carousel}\\r\\n          data-glide-dir={`${$currentPage.page}`}\\r\\n          class=\\"glide \\"\\r\\n        >\\r\\n          <div class=\\"glide__track\\" data-glide-el=\\"track\\">\\r\\n            <ul class=\\"glide__slides\\">\\r\\n              {#each images.slice(0, 14) as img, i}\\r\\n                <li class=\\"glide__slide\\">\\r\\n                  <div class=\\"slide-image-container\\">\\r\\n                    <img\\r\\n                      loading=\\"lazy\\"\\r\\n                      class=\\"carousel-image lazy\\"\\r\\n                      src={img}\\r\\n                      alt=\\"\\"\\r\\n                    />\\r\\n                  </div>\\r\\n                </li>\\r\\n              {/each}\\r\\n            </ul>\\r\\n          </div>\\r\\n        </div>\\r\\n        <button\\r\\n          on:click={() => {\\r\\n            currentPage.setPage(-1);\\r\\n          }}\\r\\n          class=\\"page-arrow-container\\"\\r\\n        >\\r\\n          <div class=\\"page-arrow-relative\\">\\r\\n            <Arrow\\r\\n              styleP=\\"object-fit:cover;width:100%;fill:white; transform:rotate(-90deg); height:100%; \\"\\r\\n            />\\r\\n          </div>\\r\\n        </button>\\r\\n      </div>\\r\\n      <CarouselThumbs page=\\"left\\" />\\r\\n    </div>\\r\\n  </div>\\r\\n</div>\\r\\n\\r\\n<style lang=\\"scss\\">.title-container {\\n  text-align: right;\\n  color: white;\\n  padding: 20px 0 20px 20px;\\n}\\n.title-container h1 {\\n  font-size: 3em;\\n  text-transform: uppercase;\\n  font-family: Orator;\\n  color: white;\\n}\\n\\n.content-container {\\n  display: flex;\\n  height: 100%;\\n  padding: 10px 0 10px 30px;\\n  overflow: hidden;\\n  flex-direction: column;\\n  align-items: flex-end;\\n  justify-content: center;\\n}\\n\\n.carousel-content-container {\\n  max-width: 500px;\\n  width: 100%;\\n  height: 100%;\\n  align-items: flex-end;\\n  display: flex;\\n  flex-direction: column;\\n  justify-content: center;\\n}\\n\\n.slide-image-container {\\n  position: relative;\\n  width: 100%;\\n  height: 100%;\\n}\\n.slide-image-container img {\\n  position: absolute;\\n  height: 100%;\\n  width: 100%;\\n}\\n\\n.glide__track {\\n  height: 100%;\\n}\\n\\n.page-arrow-container {\\n  width: 30px;\\n  height: 30px;\\n  position: absolute;\\n  left: 10px;\\n  bottom: 0;\\n  top: 50%;\\n  border-radius: 50%;\\n  background-color: rgba(0, 0, 0, 0.5);\\n  border: none;\\n  overflow: hidden;\\n}\\n.page-arrow-container .page-arrow-relative {\\n  position: absolute;\\n  top: 0;\\n  left: 0;\\n  bottom: 0;\\n  right: 0;\\n  padding: 5px;\\n  margin: auto;\\n}\\n\\n.glide__slides {\\n  height: 100%;\\n}\\n\\n.carousel-container {\\n  width: 100%;\\n  height: 65%;\\n  display: flex;\\n  position: relative;\\n}</style>\\r\\n"],"names":[],"mappings":"AAsEmB,gBAAgB,4BAAC,CAAC,AACnC,UAAU,CAAE,KAAK,CACjB,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,IAAI,AAC3B,CAAC,AACD,8BAAgB,CAAC,EAAE,cAAC,CAAC,AACnB,SAAS,CAAE,GAAG,CACd,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,MAAM,CACnB,KAAK,CAAE,KAAK,AACd,CAAC,AAED,kBAAkB,4BAAC,CAAC,AAClB,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,IAAI,CACzB,QAAQ,CAAE,MAAM,CAChB,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,QAAQ,CACrB,eAAe,CAAE,MAAM,AACzB,CAAC,AAED,2BAA2B,4BAAC,CAAC,AAC3B,SAAS,CAAE,KAAK,CAChB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,QAAQ,CACrB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,AACzB,CAAC,AAED,sBAAsB,4BAAC,CAAC,AACtB,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACd,CAAC,AACD,oCAAsB,CAAC,GAAG,cAAC,CAAC,AAC1B,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,AACb,CAAC,AAED,aAAa,4BAAC,CAAC,AACb,MAAM,CAAE,IAAI,AACd,CAAC,AAED,qBAAqB,4BAAC,CAAC,AACrB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,IAAI,CACV,MAAM,CAAE,CAAC,CACT,GAAG,CAAE,GAAG,CACR,aAAa,CAAE,GAAG,CAClB,gBAAgB,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACpC,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,MAAM,AAClB,CAAC,AACD,mCAAqB,CAAC,oBAAoB,cAAC,CAAC,AAC1C,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,MAAM,CAAE,CAAC,CACT,KAAK,CAAE,CAAC,CACR,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,IAAI,AACd,CAAC,AAED,cAAc,4BAAC,CAAC,AACd,MAAM,CAAE,IAAI,AACd,CAAC,AAED,mBAAmB,4BAAC,CAAC,AACnB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,QAAQ,AACpB,CAAC"}'
};
const CarouselLeft = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_currentPage();
  return `<div class="${"page"}"><div class="${"content-container svelte-k9el90"}"><div class="${"carousel-content-container svelte-k9el90"}"><div class="${"title-container svelte-k9el90"}"><h1 class="${"svelte-k9el90"}">ren</h1>
        <p>Browse below for interior and ext</p></div>
      <div class="${"carousel-container svelte-k9el90"}"><div${add_attribute("data-glide-dir", `${$currentPage.page}`, 0)} class="${"glide "}"${add_attribute("this", carousel, 0)}><div class="${"glide__track svelte-k9el90"}" data-glide-el="${"track"}"><ul class="${"glide__slides svelte-k9el90"}">${each(images.slice(0, 14), (img, i) => `<li class="${"glide__slide"}"><div class="${"slide-image-container svelte-k9el90"}"><img loading="${"lazy"}" class="${"carousel-image lazy svelte-k9el90"}"${add_attribute("src", img, 0)} alt="${""}"></div>
                </li>`)}</ul></div></div>
        <button class="${"page-arrow-container svelte-k9el90"}"><div class="${"page-arrow-relative svelte-k9el90"}">${validate_component(Arrow, "Arrow").$$render($$result, {
    styleP: "object-fit:cover;width:100%;fill:white; transform:rotate(-90deg); height:100%; "
  }, {}, {})}</div></button></div>
      ${validate_component(CarouselThumbs, "CarouselThumbs").$$render($$result, { page: "left" }, {}, {})}</div></div>
</div>`;
});
...
const css$e = {
  code: '.container.svelte-724cln.svelte-724cln{width:50vw;height:100vh;display:flex;align-items:center;gap:2rem;color:white;font-family:Orator;overflow:hidden}.sub-container.svelte-724cln.svelte-724cln{width:100%;height:100%;display:flex;flex-direction:column;justify-content:center}.title-container.svelte-724cln.svelte-724cln{width:100%;height:15%;margin-bottom:20px;display:flex;position:relative;font-size:3em}.svelte-724cln.svelte-724cln::-webkit-scrollbar{width:20px}.svelte-724cln.svelte-724cln::-webkit-scrollbar-track{background-color:transparent}.svelte-724cln.svelte-724cln::-webkit-scrollbar-thumb{background-color:#d6dee1;border-radius:20px;border:6px solid transparent;background-clip:content-box}.content-container.svelte-724cln.svelte-724cln{display:flex;overflow-y:auto;justify-content:center;align-items:center;width:fit-content;padding:10px;height:60%}.content-container.svelte-724cln .credits-container-sub.svelte-724cln{height:100%}.content-container.svelte-724cln .credits-container.svelte-724cln{font-size:1.3em;text-align:center;margin-bottom:1rem}.content-container.svelte-724cln .credits-container h5.svelte-724cln{font-size:1em;margin-bottom:20px}@media(max-width: 1040px){.content-container.svelte-724cln .credits-container h5.svelte-724cln{margin-bottom:10px;font-size:0.7em}}.content-container.svelte-724cln .credits-container p.svelte-724cln{font-family:"Roboto", sans-serif;font-size:0.8em}@media(max-width: 1270px){.content-container.svelte-724cln .credits-container p.svelte-724cln{font-size:0.6em}}',
...
const Credits = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"page svelte-724cln"}"><div class="${"container svelte-724cln"}" style="${"justify-content: " + escape(page === "left" ? "flex-end" : "flex-start") + ""}"><div style="${"align-items:" + escape(page === "left" ? "flex-end" : "flex-start")}" class="${"sub-container svelte-724cln"}"><div class="${"title-container svelte-724cln"}" style="${"justify-content: " + escape(page === "left" ? "flex-end" : "flex-start") + ""}">${page === "left" ? `<div class="${"title-text-container svelte-724cln"}"><h5 class="${"svelte-724cln"}">Developmen</h5></div>` : `<div class="${"title-text-container svelte-724cln"}"><h5 class="${"svelte-724cln"}">t Credits</h5></div>`}</div>
			<div class="${"content-container svelte-724cln"}"${add_attribute("this", scrollContainer, 0)}>${page === "left" ? `<div class="${"credits-container-sub svelte-724cln"}">${each(creditsContent.slice(0, 2), (credit) => `<div class="${"credits-container svelte-724cln"}"><h5 class="${"header svelte-724cln"}">${escape(credit.header)}</h5>
								${each(credit.paragraphs, (p) => `<p class="${"svelte-724cln"}">${escape(p)}</p>`)}
							</div>`)}</div>` : `<div class="${"credits-container-sub svelte-724cln"}">${each(creditsContent.slice(2, 6), (credit) => `<div class="${"credits-container svelte-724cln"}"><h5 class="${"header svelte-724cln"}">${escape(credit.header)}</h5>
								${each(credit.paragraphs, (p) => `<p class="${"svelte-724cln"}">${escape(p)}</p>`)}
							</div>`)}</div>`}</div></div></div>
</div>`;
});
...
const GalleryPreview = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"page"}"><div class="${"image-container svelte-cfqce8"}"><img loading="${"lazy"}"${add_attribute("src", highResBts[index2], 0)} alt="${""}" class="${"svelte-cfqce8"}"></div>
</div>`;
});
...
const TextPage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div style="${"background-color: " + escape(bgColor) + ";"}" class="${"page container svelte-1qq78rp"}"><div class="${"text-content svelte-1qq78rp"}"><div class="${"bu-content bu-is-large"}"><h3 class="${"header bu-content-header  svelte-1qq78rp"}">${escape(textPages[index2].header)}</h3></div>
		<div class="${"bu-content text-container svelte-1qq78rp"}"${add_attribute("this", scrollContainer, 0)}><div class="${"scroll-container-text"}"><div class="${"text-p-container"}">${each(textPages[index2].paragraphs, (text, i) => `<p${add_attribute("key", i, 0)} class="${"$1"}">${escape(text)}
						</p>`)}</div></div></div></div>
</div>`;
});
...
const css$8 = {
  code: ".indicator.svelte-7hr4yl.svelte-7hr4yl{top:5px;z-index:4;font-weight:600;text-align:center;letter-spacing:0.2em;right:5px;position:absolute;padding:5px 15px;border-radius:14px;background-color:black;color:white;display:flex;justify-content:center}.indicator.svelte-7hr4yl p.svelte-7hr4yl{margin-right:-0.2em}.title-container.svelte-7hr4yl.svelte-7hr4yl{padding:20px 20px 20px 0px;color:white}.title-container.svelte-7hr4yl h1.svelte-7hr4yl{font-size:3em;text-transform:uppercase;font-family:Orator;color:white}.slide-image-container.svelte-7hr4yl.svelte-7hr4yl{position:relative;width:100%;height:100%}.slide-image-container.svelte-7hr4yl img.svelte-7hr4yl{position:absolute;height:100%;width:100%}.carousel-content-container.svelte-7hr4yl.svelte-7hr4yl{max-width:500px;width:100%;height:100%;align-items:flex-start;display:flex;flex-direction:column;justify-content:center}.glide__slides.svelte-7hr4yl.svelte-7hr4yl{height:100%}.glide__track.svelte-7hr4yl.svelte-7hr4yl{height:100%}.page-arrow-container.svelte-7hr4yl.svelte-7hr4yl{width:30px;height:30px;position:absolute;right:10px;bottom:0;top:50%;border-radius:50%;background-color:rgba(0, 0, 0, 0.5);border:none;overflow:hidden}.page-arrow-container.svelte-7hr4yl .page-arrow-relative.svelte-7hr4yl{position:absolute;top:0;left:0;bottom:0;right:0;padding:5px;margin:auto}.content-container.svelte-7hr4yl.svelte-7hr4yl{display:flex;height:100%;overflow:hidden;padding:10px 30px 10px 0px;flex-direction:column;align-items:flex-start;justify-content:center}.carousel-container.svelte-7hr4yl.svelte-7hr4yl{width:100%;height:65%;display:flex;position:relative}.carousel-image.svelte-7hr4yl.svelte-7hr4yl{width:100%;height:100%}",
  map: '{"version":3,"file":"CarouselRight.svelte","sources":["CarouselRight.svelte"],"sourcesContent":["\uFEFF<script>\\r\\n  import Glide from \\"@glidejs/glide\\";\\r\\n  import { afterUpdate, beforeUpdate, onMount } from \\"svelte\\";\\r\\n  import { currentPage } from \\"../../stores\\";\\r\\n  import Arrow from \\"../Card/Arrow.svelte\\";\\r\\n  import CarouselThumbs from \\"../CarouselThumbs/CarouselThumbs.svelte\\";\\r\\n  import { images } from \\"../image\\";\\r\\n  export let page;\\r\\n  var glide;\\r\\n\\r\\n  let carousel;\\r\\n\\r\\n  onMount(() => {\\r\\n    glide = new Glide(carousel, {\\r\\n      dragThreshold: false,\\r\\n    });\\r\\n    glide.mount();\\r\\n  });\\r\\n\\r\\n  afterUpdate(() => {\\r\\n    glide.go(`=${$currentPage.page}`);\\r\\n  });\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"page\\">\\r\\n  <div class=\\"content-container\\">\\r\\n    <div class=\\"carousel-content-container\\">\\r\\n      <div class=\\"title-container\\">\\r\\n        <h1>ders</h1>\\r\\n        <p>erior renders of Maliview Estates.</p>\\r\\n      </div>\\r\\n      <div class=\\"carousel-container\\">\\r\\n        <div class=\\"indicator {page}\\">\\r\\n          {#if glide}\\r\\n            <p>\\r\\n              {$currentPage.page + 1}/{images.length / 2}\\r\\n            </p>\\r\\n          {/if}\\r\\n        </div>\\r\\n        <div\\r\\n          bind:this={carousel}\\r\\n          data-glide-dir={`${$currentPage.page}`}\\r\\n          class=\\"glide right\\"\\r\\n        >\\r\\n          <div class=\\"glide__track\\" data-glide-el=\\"track\\">\\r\\n            <ul class=\\"glide__slides\\">\\r\\n              {#each images.slice(14, 28) as img, i}\\r\\n                <li class=\\"glide__slide\\">\\r\\n                  <div class=\\"slide-image-container\\">\\r\\n                    <img\\r\\n                      loading=\\"lazy\\"\\r\\n                      class=\\"carousel-image\\"\\r\\n                      src={img}\\r\\n                      alt=\\"\\"\\r\\n                    />\\r\\n                  </div>\\r\\n                </li>\\r\\n              {/each}\\r\\n            </ul>\\r\\n          </div>\\r\\n        </div>\\r\\n        <button\\r\\n          on:click={() => {\\r\\n            currentPage.setPage(1);\\r\\n          }}\\r\\n          class=\\"page-arrow-container\\"\\r\\n        >\\r\\n          <div class=\\"page-arrow-relative\\">\\r\\n            <Arrow\\r\\n              styleP=\\"object-fit:cover;width:100%;fill:white; transform:rotate(90deg); height:100%; \\"\\r\\n            />\\r\\n          </div>\\r\\n        </button>\\r\\n      </div>\\r\\n      <CarouselThumbs page=\\"right\\" />\\r\\n    </div>\\r\\n  </div>\\r\\n</div>\\r\\n\\r\\n<style lang=\\"scss\\">.indicator {\\n  top: 5px;\\n  z-index: 4;\\n  font-weight: 600;\\n  text-align: center;\\n  letter-spacing: 0.2em;\\n  right: 5px;\\n  position: absolute;\\n  padding: 5px 15px;\\n  border-radius: 14px;\\n  background-color: black;\\n  color: white;\\n  display: flex;\\n  justify-content: center;\\n}\\n.indicator p {\\n  margin-right: -0.2em;\\n}\\n\\n.title-container {\\n  padding: 20px 20px 20px 0px;\\n  color: white;\\n}\\n.title-container h1 {\\n  font-size: 3em;\\n  text-transform: uppercase;\\n  font-family: Orator;\\n  color: white;\\n}\\n\\n.slide-image-container {\\n  position: relative;\\n  width: 100%;\\n  height: 100%;\\n}\\n.slide-image-container img {\\n  position: absolute;\\n  height: 100%;\\n  width: 100%;\\n}\\n\\n.carousel-content-container {\\n  max-width: 500px;\\n  width: 100%;\\n  height: 100%;\\n  align-items: flex-start;\\n  display: flex;\\n  flex-direction: column;\\n  justify-content: center;\\n}\\n\\n.glide__slides {\\n  height: 100%;\\n}\\n\\n.glide__track {\\n  height: 100%;\\n}\\n\\n.page-arrow-container {\\n  width: 30px;\\n  height: 30px;\\n  position: absolute;\\n  right: 10px;\\n  bottom: 0;\\n  top: 50%;\\n  border-radius: 50%;\\n  background-color: rgba(0, 0, 0, 0.5);\\n  border: none;\\n  overflow: hidden;\\n}\\n.page-arrow-container .page-arrow-relative {\\n  position: absolute;\\n  top: 0;\\n  left: 0;\\n  bottom: 0;\\n  right: 0;\\n  padding: 5px;\\n  margin: auto;\\n}\\n\\n.content-container {\\n  display: flex;\\n  height: 100%;\\n  overflow: hidden;\\n  padding: 10px 30px 10px 0px;\\n  flex-direction: column;\\n  align-items: flex-start;\\n  justify-content: center;\\n}\\n\\n.carousel-container {\\n  width: 100%;\\n  height: 65%;\\n  display: flex;\\n  position: relative;\\n}\\n\\n.carousel-image {\\n  width: 100%;\\n  height: 100%;\\n}</style>\\r\\n"],"names":[],"mappings":"AA+EmB,UAAU,4BAAC,CAAC,AAC7B,GAAG,CAAE,GAAG,CACR,OAAO,CAAE,CAAC,CACV,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,MAAM,CAClB,cAAc,CAAE,KAAK,CACrB,KAAK,CAAE,GAAG,CACV,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,aAAa,CAAE,IAAI,CACnB,gBAAgB,CAAE,KAAK,CACvB,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,AACzB,CAAC,AACD,wBAAU,CAAC,CAAC,cAAC,CAAC,AACZ,YAAY,CAAE,MAAM,AACtB,CAAC,AAED,gBAAgB,4BAAC,CAAC,AAChB,OAAO,CAAE,IAAI,CAAC,IAAI,CAAC,IAAI,CAAC,GAAG,CAC3B,KAAK,CAAE,KAAK,AACd,CAAC,AACD,8BAAgB,CAAC,EAAE,cAAC,CAAC,AACnB,SAAS,CAAE,GAAG,CACd,cAAc,CAAE,SAAS,CACzB,WAAW,CAAE,MAAM,CACnB,KAAK,CAAE,KAAK,AACd,CAAC,AAED,sBAAsB,4BAAC,CAAC,AACtB,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACd,CAAC,AACD,oCAAsB,CAAC,GAAG,cAAC,CAAC,AAC1B,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,AACb,CAAC,AAED,2BAA2B,4BAAC,CAAC,AAC3B,SAAS,CAAE,KAAK,CAChB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,UAAU,CACvB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,AACzB,CAAC,AAED,cAAc,4BAAC,CAAC,AACd,MAAM,CAAE,IAAI,AACd,CAAC,AAED,aAAa,4BAAC,CAAC,AACb,MAAM,CAAE,IAAI,AACd,CAAC,AAED,qBAAqB,4BAAC,CAAC,AACrB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,CAAC,CACT,GAAG,CAAE,GAAG,CACR,aAAa,CAAE,GAAG,CAClB,gBAAgB,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACpC,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,MAAM,AAClB,CAAC,AACD,mCAAqB,CAAC,oBAAoB,cAAC,CAAC,AAC1C,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,MAAM,CAAE,CAAC,CACT,KAAK,CAAE,CAAC,CACR,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,IAAI,AACd,CAAC,AAED,kBAAkB,4BAAC,CAAC,AAClB,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,MAAM,CAChB,OAAO,CAAE,IAAI,CAAC,IAAI,CAAC,IAAI,CAAC,GAAG,CAC3B,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,UAAU,CACvB,eAAe,CAAE,MAAM,AACzB,CAAC,AAED,mBAAmB,4BAAC,CAAC,AACnB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,QAAQ,AACpB,CAAC,AAED,eAAe,4BAAC,CAAC,AACf,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACd,CAAC"}'
};
const CarouselRight = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_currentPage();
  return `<div class="${"page"}"><div class="${"content-container svelte-7hr4yl"}"><div class="${"carousel-content-container svelte-7hr4yl"}"><div class="${"title-container svelte-7hr4yl"}"><h1 class="${"svelte-7hr4yl"}">ders</h1>
        <p>erior renders of Maliview Estates.</p></div>
      <div class="${"carousel-container svelte-7hr4yl"}"><div class="${"indicator " + escape(page) + " svelte-7hr4yl"}">${``}</div>
        <div${add_attribute("data-glide-dir", `${$currentPage.page}`, 0)} class="${"glide right"}"${add_attribute("this", carousel, 0)}><div class="${"glide__track svelte-7hr4yl"}" data-glide-el="${"track"}"><ul class="${"glide__slides svelte-7hr4yl"}">${each(images.slice(14, 28), (img, i) => `<li class="${"glide__slide"}"><div class="${"slide-image-container svelte-7hr4yl"}"><img loading="${"lazy"}" class="${"carousel-image svelte-7hr4yl"}"${add_attribute("src", img, 0)} alt="${""}"></div>
                </li>`)}</ul></div></div>
        <button class="${"page-arrow-container svelte-7hr4yl"}"><div class="${"page-arrow-relative svelte-7hr4yl"}">${validate_component(Arrow, "Arrow").$$render($$result, {
    styleP: "object-fit:cover;width:100%;fill:white; transform:rotate(90deg); height:100%; "
  }, {}, {})}</div></button></div>
      ${validate_component(CarouselThumbs, "CarouselThumbs").$$render($$result, { page: "right" }, {}, {})}</div></div>
</div>`;
});
...
const css$7 = {
  code: '.overlay-image.svelte-1eq3xzn.svelte-1eq3xzn{position:relative;border:1px solid white}.overlay-image.svelte-1eq3xzn.svelte-1eq3xzn::before{z-index:2;content:"";height:100%;width:100%;position:absolute;display:block;background-color:rgba(0, 0, 0, 0.5)}.grid-container.svelte-1eq3xzn.svelte-1eq3xzn{display:grid;height:100%;grid-template-columns:repeat(10, 1fr);grid-template-rows:repeat(20, minmax(calc(100% / 4), 1fr));gap:5px}.grid-container.svelte-1eq3xzn .grid-image-container.svelte-1eq3xzn:nth-child(n+2):nth-child(-n+5){grid-column:span 1;grid-row:span 1}.grid-container.svelte-1eq3xzn .grid-image-container.svelte-1eq3xzn:nth-child(8){grid-column:span 4;grid-row:span 1}.grid-container.svelte-1eq3xzn .grid-image-container.svelte-1eq3xzn:nth-child(12){grid-column:span 4;grid-row:span 1}.grid-container.svelte-1eq3xzn .grid-image-container.svelte-1eq3xzn{grid-column:span 3;grid-row:span 1;overflow:hidden;width:100%}.grid-container.svelte-1eq3xzn .grid-image-container img.svelte-1eq3xzn{object-fit:cover}.grid-container.svelte-1eq3xzn iframe.svelte-1eq3xzn{grid-column-end:span 7;height:100%}.overlay-image.svelte-1eq3xzn.svelte-1eq3xzn{position:relative}.overlay-image.svelte-1eq3xzn.svelte-1eq3xzn::before{z-index:2;content:"";height:100%;width:100%;position:absolute;display:block;background-color:rgba(0, 0, 0, 0.5)}img.svelte-1eq3xzn.svelte-1eq3xzn{width:100%;height:100%}',
  map: `{"version":3,"file":"Gallery.svelte","sources":["Gallery.svelte"],"sourcesContent":["\uFEFF<script>\\r\\n  import { galleryImg } from \\"../../stores\\";\\r\\n  import GalleryImage from \\"../GalleryImage/GalleryImage.svelte\\";\\r\\n\\r\\n  let selected;\\r\\n  const images = [\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879411/gallery/2021.05.29_roof_2_ontfwx.jpg\\",\\r\\n\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879411/gallery/Amit_and_Russel_m0lcjt.jpg\\",\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879411/gallery/Bike_frqokt.jpg\\",\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879411/gallery/Framing_d7ovrn.jpg\\",\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879411/gallery/Humming_Bird_vgziao.jpg\\",\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879411/gallery/circle_window_with_pendant_light_fbnnsd.jpg\\",\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879411/gallery/dining_room_discussion_wyhfjh.jpg\\",\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879412/gallery/electrical_2_hzrwdq.jpg\\",\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879412/gallery/electrical_discussion_fzgod7.jpg\\",\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879412/gallery/framing_discussion_skcuns.jpg\\",\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879411/gallery/kitchen_discussion_2_mqzixc.jpg\\",\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879411/gallery/kitchen_discussion_3_wwredc.jpg\\",\\r\\n    \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630879411/gallery/kitchen_discussion_ynx88u.jpg\\",\\r\\n  ];\\r\\n  const selectImage = (i) => {\\r\\n    galleryImg.set(i);\\r\\n    selected = $galleryImg;\\r\\n  };\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"page\\">\\r\\n  <div class=\\"grid-container\\">\\r\\n    {#each images as img, i}\\r\\n      <svelte:component this={GalleryImage}>\\r\\n        <div\\r\\n          class=\\"grid-image-container {selected === i ? 'overlay-image' : ''}\\"\\r\\n          index={i}\\r\\n        >\\r\\n          <img\\r\\n            on:click={() => {\\r\\n              selectImage(i);\\r\\n            }}\\r\\n            loading=\\"lazy\\"\\r\\n            src={img}\\r\\n            alt=\\"\\"\\r\\n          />\\r\\n        </div>\\r\\n      </svelte:component>\\r\\n    {/each}\\r\\n    <iframe\\r\\n      class=\\"video-modal\\"\\r\\n      width=\\"100%\\"\\r\\n      src=\\"https://www.youtube.com/embed/nTS10ZQM5Ms\\"\\r\\n      title=\\"YouTube video player\\"\\r\\n      allow=\\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\\"\\r\\n    />\\r\\n  </div>\\r\\n</div>\\r\\n\\r\\n<style lang=\\"scss\\">.overlay-image {\\n  position: relative;\\n  border: 1px solid white;\\n}\\n.overlay-image::before {\\n  z-index: 2;\\n  content: \\"\\";\\n  height: 100%;\\n  width: 100%;\\n  position: absolute;\\n  display: block;\\n  background-color: rgba(0, 0, 0, 0.5);\\n}\\n\\n.grid-container {\\n  display: grid;\\n  height: 100%;\\n  grid-template-columns: repeat(10, 1fr);\\n  grid-template-rows: repeat(20, minmax(calc(100% / 4), 1fr));\\n  gap: 5px;\\n}\\n.grid-container .grid-image-container:nth-child(n+2):nth-child(-n+5) {\\n  grid-column: span 1;\\n  grid-row: span 1;\\n}\\n.grid-container .grid-image-container:nth-child(8) {\\n  grid-column: span 4;\\n  grid-row: span 1;\\n}\\n.grid-container .grid-image-container:nth-child(12) {\\n  grid-column: span 4;\\n  grid-row: span 1;\\n}\\n.grid-container .grid-image-container {\\n  grid-column: span 3;\\n  grid-row: span 1;\\n  overflow: hidden;\\n  width: 100%;\\n}\\n.grid-container .grid-image-container img {\\n  object-fit: cover;\\n}\\n.grid-container iframe {\\n  grid-column-end: span 7;\\n  height: 100%;\\n}\\n\\n.overlay-image {\\n  position: relative;\\n}\\n.overlay-image::before {\\n  z-index: 2;\\n  content: \\"\\";\\n  height: 100%;\\n  width: 100%;\\n  position: absolute;\\n  display: block;\\n  background-color: rgba(0, 0, 0, 0.5);\\n}\\n\\nimg {\\n  width: 100%;\\n  height: 100%;\\n}</style>\\r\\n"],"names":[],"mappings":"AAwDmB,cAAc,8BAAC,CAAC,AACjC,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,AACzB,CAAC,AACD,4CAAc,QAAQ,AAAC,CAAC,AACtB,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,EAAE,CACX,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,KAAK,CACd,gBAAgB,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACtC,CAAC,AAED,eAAe,8BAAC,CAAC,AACf,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,qBAAqB,CAAE,OAAO,EAAE,CAAC,CAAC,GAAG,CAAC,CACtC,kBAAkB,CAAE,OAAO,EAAE,CAAC,CAAC,OAAO,KAAK,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAC3D,GAAG,CAAE,GAAG,AACV,CAAC,AACD,8BAAe,CAAC,oCAAqB,WAAW,GAAG,CAAC,WAAW,IAAI,CAAC,AAAC,CAAC,AACpE,WAAW,CAAE,IAAI,CAAC,CAAC,CACnB,QAAQ,CAAE,IAAI,CAAC,CAAC,AAClB,CAAC,AACD,8BAAe,CAAC,oCAAqB,WAAW,CAAC,CAAC,AAAC,CAAC,AAClD,WAAW,CAAE,IAAI,CAAC,CAAC,CACnB,QAAQ,CAAE,IAAI,CAAC,CAAC,AAClB,CAAC,AACD,8BAAe,CAAC,oCAAqB,WAAW,EAAE,CAAC,AAAC,CAAC,AACnD,WAAW,CAAE,IAAI,CAAC,CAAC,CACnB,QAAQ,CAAE,IAAI,CAAC,CAAC,AAClB,CAAC,AACD,8BAAe,CAAC,qBAAqB,eAAC,CAAC,AACrC,WAAW,CAAE,IAAI,CAAC,CAAC,CACnB,QAAQ,CAAE,IAAI,CAAC,CAAC,CAChB,QAAQ,CAAE,MAAM,CAChB,KAAK,CAAE,IAAI,AACb,CAAC,AACD,8BAAe,CAAC,qBAAqB,CAAC,GAAG,eAAC,CAAC,AACzC,UAAU,CAAE,KAAK,AACnB,CAAC,AACD,8BAAe,CAAC,MAAM,eAAC,CAAC,AACtB,eAAe,CAAE,IAAI,CAAC,CAAC,CACvB,MAAM,CAAE,IAAI,AACd,CAAC,AAED,cAAc,8BAAC,CAAC,AACd,QAAQ,CAAE,QAAQ,AACpB,CAAC,AACD,4CAAc,QAAQ,AAAC,CAAC,AACtB,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,EAAE,CACX,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,KAAK,CACd,gBAAgB,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACtC,CAAC,AAED,GAAG,8BAAC,CAAC,AACH,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACd,CAAC"}`
};
const Gallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"page"}"><div class="${"grid-container svelte-1eq3xzn"}">${each(images2, (img, i) => `${validate_component(GalleryImage || missing_component, "svelte:component").$$render($$result, {}, {}, {
    default: () => `<div class="${"grid-image-container " + escape(selected === i ? "overlay-image" : "") + " svelte-1eq3xzn"}"${add_attribute("index", i, 0)}><img loading="${"lazy"}"${add_attribute("src", img, 0)} alt="${""}" class="${"svelte-1eq3xzn"}"></div>
      `
  })}`)}
    <iframe class="${"video-modal svelte-1eq3xzn"}" width="${"100%"}" src="${"https://www.youtube.com/embed/nTS10ZQM5Ms"}" title="${"YouTube video player"}" allow="${"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}"></iframe></div>
</div>`;
});
...
const css$3 = {
  code: ".page-arrow-container.svelte-wjwtft.svelte-wjwtft{width:30px;height:30px;position:absolute;border-radius:50%;background-color:rgba(0, 0, 0, 0.5);border:none;overflow:hidden}.page-arrow-container.svelte-wjwtft .page-arrow-relative.svelte-wjwtft{position:absolute;top:0;left:0;bottom:0;right:0;padding:5px;margin:auto}.indicator.svelte-wjwtft.svelte-wjwtft{z-index:3;font-weight:600;text-align:center;letter-spacing:0.2em;bottom:5px;left:5px;position:absolute;padding:5px 15px;border-radius:14px;background-color:black;color:white;display:flex;justify-content:center}.indicator.svelte-wjwtft p.svelte-wjwtft{margin-right:-0.2em}.square-place-holder.svelte-wjwtft.svelte-wjwtft{width:100%;height:100%}.square-place-holder.svelte-wjwtft img.svelte-wjwtft{width:100%;height:100%;object-fit:cover}h5.svelte-wjwtft.svelte-wjwtft{font-family:Orator}.font-white.svelte-wjwtft.svelte-wjwtft{color:white}.card-content.svelte-wjwtft.svelte-wjwtft{background-color:transparent}.content.svelte-wjwtft.svelte-wjwtft{max-height:20rem;overflow:hidden;display:-webkit-box;-webkit-line-clamp:4;-webkit-box-orient:vertical}.card-container.svelte-wjwtft.svelte-wjwtft{display:flex;flex-direction:column;background-color:transparent}.carousel-container.svelte-wjwtft .glide-image-container.svelte-wjwtft{display:flex;padding-bottom:100%;height:0;position:relative;justify-content:center}.carousel-container.svelte-wjwtft .glide-image-container img.svelte-wjwtft{width:100%;height:100%;position:absolute;object-fit:cover}.page-arrow-container.svelte-wjwtft.svelte-wjwtft{width:30px;border-radius:50%;position:absolute;border:none;overflow:hidden;height:30px;bottom:0}.arrow-left.svelte-wjwtft.svelte-wjwtft{right:40px;bottom:5px}.arrow-right.svelte-wjwtft.svelte-wjwtft{transform:rotate(180deg);right:5px;bottom:5px}.carousel-image.svelte-wjwtft.svelte-wjwtft{object-fit:cover}.show-more.svelte-wjwtft.svelte-wjwtft{display:block;max-height:100%}",
  map: `{"version":3,"file":"CardCarousel.svelte","sources":["CardCarousel.svelte"],"sourcesContent":["\uFEFF<script>\\r\\n  import { browser } from \\"$app/env\\";\\r\\n  import Glide from \\"@glidejs/glide\\";\\r\\n  import { onDestroy, onMount } from \\"svelte\\";\\r\\n  import { navToLink, textPages } from \\"../../pageContent\\";\\r\\n  import Arrow from \\"../Card/Arrow.svelte\\";\\r\\n  export let index;\\r\\n  export let page;\\r\\n  let carousel;\\r\\n  let glide;\\r\\n  let showMore = false;\\r\\n\\r\\n  let overFlowing;\\r\\n  let mainText;\\r\\n\\r\\n  const images = {\\r\\n    renders: [\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887731/rendersHighRes/33340_MULHOLLAND_INT_IMG_12A_00-min_ciecgp.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887728/rendersHighRes/33340_MULHOLLAND_INT_IMG_14A-min_a51cfk.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887729/rendersHighRes/33340_MULHOLLAND_INT_IMG_16A_00-min_qgp2ne.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887729/rendersHighRes/33340_MULHOLLAND_INT_IMG_24A-min_hsnpta.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887729/rendersHighRes/33340_MULHOLLAND_INT_IMG_26A-min_d1dxwf.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887729/rendersHighRes/33340_MULHOLLAND_INT_IMG_26B-min_jthbj4.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887728/rendersHighRes/33340_MULHOLLAND_INT_IMG_30A-min_yvenyq.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887729/rendersHighRes/33340_MULHOLLAND_INT_IMG_31A-min_mo1cj5.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887728/rendersHighRes/33340_MULHOLLAND_INT_IMG_34A-min_z5fw2h.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887730/rendersHighRes/33340_MULHOLLAND_INT_IMG_34B-min_ggb1xk.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887730/rendersHighRes/33340_MULHOLLAND_INT_IMG_34C-min_y3bogv.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887730/rendersHighRes/33340_MULHOLLAND_INT_IMG_3A_00-min_b0yvdi.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1630887731/rendersHighRes/33340_MULHOLLAND_INT_IMG_4A-min_ihzxkw.jpg\\",\\r\\n    ],\\r\\n    floorplans: [\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1633199065/FloorPlans/33340_Mullholland_Hwy_SITE_PLAN_gbvv7f.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1633199064/FloorPlans/33340_Mullholland_Hwy_1ST_FLOOR_BLACK_20211001_qrb856.jpg\\",\\r\\n      \\"https://res.cloudinary.com/dt4xntymn/image/upload/v1633199063/FloorPlans/33340_Mullholland_Hwy_2ND_FLOOR_20211001_cmgvbq.jpg\\",\\r\\n    ],\\r\\n  };\\r\\n\\r\\n  let glideIndex = 0;\\r\\n\\r\\n  onMount(() => {\\r\\n    glide = new Glide(carousel);\\r\\n\\r\\n    glide.mount();\\r\\n    glide.on(\\"run\\", function () {\\r\\n      glideIndex = glide.index;\\r\\n    });\\r\\n    if (browser) {\\r\\n      window.addEventListener(\\"resize\\", checkOverFlow);\\r\\n    }\\r\\n\\r\\n    checkOverFlow();\\r\\n  });\\r\\n  function checkOverFlow() {\\r\\n    if (mainText.scrollHeight > mainText.clientHeight) {\\r\\n      overFlowing = true;\\r\\n    } else {\\r\\n      overFlowing = false;\\r\\n    }\\r\\n  }\\r\\n\\r\\n  onDestroy(() => {\\r\\n    if (browser) {\\r\\n      window.removeEventListener(\\"resize\\", checkOverFlow);\\r\\n    }\\r\\n  });\\r\\n<\/script>\\r\\n\\r\\n<div id={navToLink[index + 1]} class=\\"bu-card card-container\\">\\r\\n  <div class=\\"carousel-container\\">\\r\\n    <div bind:this={carousel} class=\\"glide\\">\\r\\n      <div class=\\"indicator\\">\\r\\n        {#if glide}\\r\\n          <p>\\r\\n            {glideIndex + 1}/{images[page.title].length}\\r\\n          </p>\\r\\n        {/if}\\r\\n      </div>\\r\\n      <div class=\\"glide__track\\" data-glide-el=\\"track\\">\\r\\n        <ul class=\\"glide__slides\\">\\r\\n          {#each images[page.title] as img, i}\\r\\n            <li class=\\"glide__slide\\">\\r\\n              <div class=\\"glide-image-container\\">\\r\\n                <img loading=\\"lazy\\" class=\\"carousel-image\\" src={img} alt=\\"\\" />\\r\\n              </div>\\r\\n            </li>\\r\\n          {/each}\\r\\n        </ul>\\r\\n      </div>\\r\\n      <div class=\\"glide__arrows\\" data-glide-el=\\"controls\\">\\r\\n        <button data-glide-dir=\\"<\\" class=\\"page-arrow-container arrow-left\\">\\r\\n          <div class=\\"page-arrow-relative\\">\\r\\n            <Arrow\\r\\n              styleP=\\"object-fit:cover;width:100%;fill:white; transform:rotate(-90deg); height:100%; \\"\\r\\n            />\\r\\n          </div>\\r\\n        </button>\\r\\n        <button data-glide-dir=\\">\\" class=\\"page-arrow-container arrow-right \\">\\r\\n          <div class=\\"page-arrow-relative\\">\\r\\n            <Arrow\\r\\n              styleP=\\"object-fit:cover;width:100%;fill:white; transform:rotate(-90deg); height:100%; \\"\\r\\n            />\\r\\n          </div>\\r\\n        </button>\\r\\n      </div>\\r\\n    </div>\\r\\n  </div>\\r\\n  <div class=\\"card-content bu-card-content\\">\\r\\n    <div class=\\"bu-media\\">\\r\\n      <div class=\\"bu-media-left\\">\\r\\n        <figure class=\\"bu-image bu-is-48x48\\">\\r\\n          <div class=\\"square-place-holder\\" style=\\" height: 100%; width:100%;\\">\\r\\n            <img\\r\\n              src=\\"https://res.cloudinary.com/dt4xntymn/image/upload/v1631671006/misc/Maliview_cswlog.png\\"\\r\\n              alt=\\"\\"\\r\\n            />\\r\\n          </div>\\r\\n        </figure>\\r\\n      </div>\\r\\n      {#if textPages[index]}\\r\\n        <h5 class=\\"title is-4 font-white\\">\\r\\n          {textPages[index].header}\\r\\n        </h5>\\r\\n      {/if}\\r\\n    </div>\\r\\n    <div\\r\\n      bind:this={mainText}\\r\\n      class=\\"content bu-is-clipped content font-white {showMore\\r\\n        ? 'show-more'\\r\\n        : ''}\\"\\r\\n    >\\r\\n      {#if textPages[index]}\\r\\n        {#each textPages[index].paragraphs as p}\\r\\n          <p>{p}</p>\\r\\n        {/each}\\r\\n      {/if}\\r\\n    </div>\\r\\n    <br />\\r\\n    {#if overFlowing}\\r\\n      <div\\r\\n        on:click={() => {\\r\\n          showMore = !showMore;\\r\\n        }}\\r\\n        class=\\"bu-level bu-is-mobile\\"\\r\\n      >\\r\\n        <div class=\\"bu-level-left\\">\\r\\n          <p class=\\"bu-level-left bu-level-item\\">Read More</p>\\r\\n          <span class=\\"bu-level-left bu-level-item bu-icon bu-is-small\\">\\r\\n            <Arrow styleP=\\"height:16px; width:16px;\\" {showMore} />\\r\\n          </span>\\r\\n        </div>\\r\\n      </div>\\r\\n    {/if}\\r\\n  </div>\\r\\n</div>\\r\\n\\r\\n<style lang=\\"scss\\">.page-arrow-container {\\n  width: 30px;\\n  height: 30px;\\n  position: absolute;\\n  border-radius: 50%;\\n  background-color: rgba(0, 0, 0, 0.5);\\n  border: none;\\n  overflow: hidden;\\n}\\n.page-arrow-container .page-arrow-relative {\\n  position: absolute;\\n  top: 0;\\n  left: 0;\\n  bottom: 0;\\n  right: 0;\\n  padding: 5px;\\n  margin: auto;\\n}\\n\\n.indicator {\\n  z-index: 3;\\n  font-weight: 600;\\n  text-align: center;\\n  letter-spacing: 0.2em;\\n  bottom: 5px;\\n  left: 5px;\\n  position: absolute;\\n  padding: 5px 15px;\\n  border-radius: 14px;\\n  background-color: black;\\n  color: white;\\n  display: flex;\\n  justify-content: center;\\n}\\n.indicator p {\\n  margin-right: -0.2em;\\n}\\n\\n.square-place-holder {\\n  width: 100%;\\n  height: 100%;\\n}\\n.square-place-holder img {\\n  width: 100%;\\n  height: 100%;\\n  object-fit: cover;\\n}\\n\\nh5 {\\n  font-family: Orator;\\n}\\n\\n.font-white {\\n  color: white;\\n}\\n\\n.card-content {\\n  background-color: transparent;\\n}\\n\\n.content {\\n  max-height: 20rem;\\n  overflow: hidden;\\n  display: -webkit-box;\\n  -webkit-line-clamp: 4;\\n  -webkit-box-orient: vertical;\\n}\\n\\n.card-container {\\n  display: flex;\\n  flex-direction: column;\\n  background-color: transparent;\\n}\\n\\n.carousel-container .glide-image-container {\\n  display: flex;\\n  padding-bottom: 100%;\\n  height: 0;\\n  position: relative;\\n  justify-content: center;\\n}\\n.carousel-container .glide-image-container img {\\n  width: 100%;\\n  height: 100%;\\n  position: absolute;\\n  object-fit: cover;\\n}\\n\\n.page-arrow-container {\\n  width: 30px;\\n  border-radius: 50%;\\n  position: absolute;\\n  border: none;\\n  overflow: hidden;\\n  height: 30px;\\n  bottom: 0;\\n}\\n\\n.arrow-left {\\n  right: 40px;\\n  bottom: 5px;\\n}\\n\\n.arrow-right {\\n  transform: rotate(180deg);\\n  right: 5px;\\n  bottom: 5px;\\n}\\n\\n.carousel-image {\\n  object-fit: cover;\\n}\\n\\n.show-more {\\n  display: block;\\n  max-height: 100%;\\n}</style>\\r\\n"],"names":[],"mappings":"AA4JmB,qBAAqB,4BAAC,CAAC,AACxC,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,QAAQ,CAClB,aAAa,CAAE,GAAG,CAClB,gBAAgB,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACpC,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,MAAM,AAClB,CAAC,AACD,mCAAqB,CAAC,oBAAoB,cAAC,CAAC,AAC1C,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,MAAM,CAAE,CAAC,CACT,KAAK,CAAE,CAAC,CACR,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,IAAI,AACd,CAAC,AAED,UAAU,4BAAC,CAAC,AACV,OAAO,CAAE,CAAC,CACV,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,MAAM,CAClB,cAAc,CAAE,KAAK,CACrB,MAAM,CAAE,GAAG,CACX,IAAI,CAAE,GAAG,CACT,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,aAAa,CAAE,IAAI,CACnB,gBAAgB,CAAE,KAAK,CACvB,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,AACzB,CAAC,AACD,wBAAU,CAAC,CAAC,cAAC,CAAC,AACZ,YAAY,CAAE,MAAM,AACtB,CAAC,AAED,oBAAoB,4BAAC,CAAC,AACpB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACd,CAAC,AACD,kCAAoB,CAAC,GAAG,cAAC,CAAC,AACxB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,KAAK,AACnB,CAAC,AAED,EAAE,4BAAC,CAAC,AACF,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,WAAW,4BAAC,CAAC,AACX,KAAK,CAAE,KAAK,AACd,CAAC,AAED,aAAa,4BAAC,CAAC,AACb,gBAAgB,CAAE,WAAW,AAC/B,CAAC,AAED,QAAQ,4BAAC,CAAC,AACR,UAAU,CAAE,KAAK,CACjB,QAAQ,CAAE,MAAM,CAChB,OAAO,CAAE,WAAW,CACpB,kBAAkB,CAAE,CAAC,CACrB,kBAAkB,CAAE,QAAQ,AAC9B,CAAC,AAED,eAAe,4BAAC,CAAC,AACf,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,gBAAgB,CAAE,WAAW,AAC/B,CAAC,AAED,iCAAmB,CAAC,sBAAsB,cAAC,CAAC,AAC1C,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,IAAI,CACpB,MAAM,CAAE,CAAC,CACT,QAAQ,CAAE,QAAQ,CAClB,eAAe,CAAE,MAAM,AACzB,CAAC,AACD,iCAAmB,CAAC,sBAAsB,CAAC,GAAG,cAAC,CAAC,AAC9C,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,KAAK,AACnB,CAAC,AAED,qBAAqB,4BAAC,CAAC,AACrB,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,MAAM,CAChB,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,CAAC,AACX,CAAC,AAED,WAAW,4BAAC,CAAC,AACX,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,AACb,CAAC,AAED,YAAY,4BAAC,CAAC,AACZ,SAAS,CAAE,OAAO,MAAM,CAAC,CACzB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,AACb,CAAC,AAED,eAAe,4BAAC,CAAC,AACf,UAAU,CAAE,KAAK,AACnB,CAAC,AAED,UAAU,4BAAC,CAAC,AACV,OAAO,CAAE,KAAK,CACd,UAAU,CAAE,IAAI,AAClB,CAAC"}`
};
const CardCarousel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div${add_attribute("id", navToLink[index2 + 1], 0)} class="${"bu-card card-container svelte-wjwtft"}"><div class="${"carousel-container svelte-wjwtft"}"><div class="${"glide"}"${add_attribute("this", carousel, 0)}><div class="${"indicator svelte-wjwtft"}">${``}</div>
      <div class="${"glide__track"}" data-glide-el="${"track"}"><ul class="${"glide__slides"}">${each(images2[page.title], (img, i) => `<li class="${"glide__slide"}"><div class="${"glide-image-container svelte-wjwtft"}"><img loading="${"lazy"}" class="${"carousel-image svelte-wjwtft"}"${add_attribute("src", img, 0)} alt="${""}"></div>
            </li>`)}</ul></div>
      <div class="${"glide__arrows"}" data-glide-el="${"controls"}"><button data-glide-dir="${"<"}" class="${"page-arrow-container arrow-left svelte-wjwtft"}"><div class="${"page-arrow-relative svelte-wjwtft"}">${validate_component(Arrow, "Arrow").$$render($$result, {
    styleP: "object-fit:cover;width:100%;fill:white; transform:rotate(-90deg); height:100%; "
  }, {}, {})}</div></button>
        <button data-glide-dir="${">"}" class="${"page-arrow-container arrow-right  svelte-wjwtft"}"><div class="${"page-arrow-relative svelte-wjwtft"}">${validate_component(Arrow, "Arrow").$$render($$result, {
    styleP: "object-fit:cover;width:100%;fill:white; transform:rotate(-90deg); height:100%; "
  }, {}, {})}</div></button></div></div></div>
  <div class="${"card-content bu-card-content svelte-wjwtft"}"><div class="${"bu-media"}"><div class="${"bu-media-left"}"><figure class="${"bu-image bu-is-48x48"}"><div class="${"square-place-holder svelte-wjwtft"}" style="${"height: 100%; width:100%;"}"><img src="${"https://res.cloudinary.com/dt4xntymn/image/upload/v1631671006/misc/Maliview_cswlog.png"}" alt="${""}" class="${"svelte-wjwtft"}"></div></figure></div>
      ${textPages[index2] ? `<h5 class="${"title is-4 font-white svelte-wjwtft"}">${escape(textPages[index2].header)}</h5>` : ``}</div>
    <div class="${"content bu-is-clipped content font-white " + escape("") + " svelte-wjwtft"}"${add_attribute("this", mainText, 0)}>${textPages[index2] ? `${each(textPages[index2].paragraphs, (p) => `<p>${escape(p)}</p>`)}` : ``}</div>
    <br>
    ${``}</div>
</div>`;
});
...
const CardGallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div><div id="${"behind-the-scenes"}" class="${"container svelte-9rfmxn"}"><div class="${"bu-title bu-has-text-centered svelte-9rfmxn"}">behind the scenes</div>
		<div class="${"gallery-container svelte-9rfmxn"}">${each(images2, (image, i) => `<div class="${"image-container svelte-9rfmxn"}"><img${add_attribute("src", image, 0)} loading="${"lazy"}" alt="${""}" class="${"svelte-9rfmxn"}">
				</div>`)}</div></div>
</div>`;
});
