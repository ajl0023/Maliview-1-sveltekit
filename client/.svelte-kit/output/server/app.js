...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-3f7e7a41.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-3f7e7a41.js", assets + "/_app/chunks/vendor-04bdbe9d.js"]
    },
    fetched: void 0,
    floc: false,
...
const metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-b5830e83.js", "css": [], "js": ["layout.svelte-b5830e83.js", "chunks/vendor-04bdbe9d.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-455283b3.js", "css": [], "js": ["error.svelte-455283b3.js", "chunks/vendor-04bdbe9d.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-ca166563.js", "css": ["assets/pages/index.svelte-406ca4ff.css"], "js": ["pages/index.svelte-ca166563.js", "chunks/vendor-04bdbe9d.js"], "styles": [] } };
...
const galleryImg = writable({
  currPhase: "phase-1",
  index: 0,
  imageToDisplay: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880378/galleryHighRes/phase1/kitchen_discussion_ipeyz4.jpg"
});
...
const css$9 = {
  code: '.phase-1.svelte-1fnpcqz.svelte-1fnpcqz{max-height:25%}.phase-2.svelte-1fnpcqz.svelte-1fnpcqz{max-height:calc(100% / 6)}.image-container.svelte-1fnpcqz.svelte-1fnpcqz{width:100%;height:100%}.image-container.svelte-1fnpcqz img.svelte-1fnpcqz{object-fit:cover;cursor:pointer;width:100%;height:100%}.overlay-image.svelte-1fnpcqz.svelte-1fnpcqz{position:relative;border:1px solid white}.overlay-image.svelte-1fnpcqz.svelte-1fnpcqz::before{z-index:2;content:"";height:100%;width:100%;position:absolute;display:block;background-color:rgba(0, 0, 0, 0.5)}',
  map: `{"version":3,"file":"GallerySelected.svelte","sources":["GallerySelected.svelte"],"sourcesContent":["<script>\\r\\n  import { galleryImg } from \\"./../GalleryPreview/store.js\\";\\r\\n  import { createEventDispatcher } from \\"svelte\\";\\r\\n\\r\\n  export let img;\\r\\n  export let selected;\\r\\n  const dispatch = createEventDispatcher();\\r\\n<\/script>\\r\\n\\r\\n<div\\r\\n  class=\\"{$galleryImg.currPhase} image-container {selected === img.index\\r\\n    ? 'overlay-image'\\r\\n    : ''}\\"\\r\\n>\\r\\n  <img\\r\\n    on:click={() => {\\r\\n      galleryImg.update((s) => {\\r\\n        s.index = img.index;\\r\\n        s.imageToDisplay = img.raw;\\r\\n        return s;\\r\\n      });\\r\\n      dispatch(\\"select\\", img.index);\\r\\n    }}\\r\\n    loading=\\"lazy\\"\\r\\n    src={img.url}\\r\\n    alt=\\"\\"\\r\\n  />\\r\\n</div>\\r\\n\\r\\n<style lang=\\"scss\\">.phase-1 {\\n  max-height: 25%;\\n}\\n\\n.phase-2 {\\n  max-height: calc(100% / 6);\\n}\\n\\n.image-container {\\n  width: 100%;\\n  height: 100%;\\n}\\n.image-container img {\\n  object-fit: cover;\\n  cursor: pointer;\\n  width: 100%;\\n  height: 100%;\\n}\\n\\n.overlay-image {\\n  position: relative;\\n  border: 1px solid white;\\n}\\n.overlay-image::before {\\n  z-index: 2;\\n  content: \\"\\";\\n  height: 100%;\\n  width: 100%;\\n  position: absolute;\\n  display: block;\\n  background-color: rgba(0, 0, 0, 0.5);\\n}</style>\\r\\n"],"names":[],"mappings":"AA6BmB,QAAQ,8BAAC,CAAC,AAC3B,UAAU,CAAE,GAAG,AACjB,CAAC,AAED,QAAQ,8BAAC,CAAC,AACR,UAAU,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,AAC5B,CAAC,AAED,gBAAgB,8BAAC,CAAC,AAChB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACd,CAAC,AACD,+BAAgB,CAAC,GAAG,eAAC,CAAC,AACpB,UAAU,CAAE,KAAK,CACjB,MAAM,CAAE,OAAO,CACf,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACd,CAAC,AAED,cAAc,8BAAC,CAAC,AACd,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,AACzB,CAAC,AACD,4CAAc,QAAQ,AAAC,CAAC,AACtB,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,EAAE,CACX,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,KAAK,CACd,gBAAgB,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACtC,CAAC"}`
};
const GallerySelected = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_galleryImg();
  return `<div class="${escape($galleryImg.currPhase) + " image-container " + escape(selected === img.index ? "overlay-image" : "") + " svelte-1fnpcqz"}"><img loading="${"lazy"}"${add_attribute("src", img.url, 0)} alt="${""}" class="${"svelte-1fnpcqz"}">
</div>`;
});
const images = {
  "phase-1": {
    main: [
      [
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477177/gallery/phase1/kitchen_discussion_ipeyz4_lxmp9f.webp",
          index: 0,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880378/galleryHighRes/phase1/kitchen_discussion_ipeyz4.jpg"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477177/gallery/phase1/kitchen_discussion_3_jniqgh_vnn1ci.webp",
          index: 1,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880378/galleryHighRes/phase1/kitchen_discussion_3_jniqgh.jpg"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477178/gallery/phase1/kitchen_discussion_2_mzb1yv_hxv1xu.webp",
          index: 2,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880377/galleryHighRes/phase1/kitchen_discussion_2_mzb1yv.jpg"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477177/gallery/phase1/framing_discussion_tmw90t_f66mvf.webp",
          index: 3,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880379/galleryHighRes/phase1/framing_discussion_tmw90t.jpg"
        }
      ],
      [
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477178/gallery/phase1/electrical_discussion_qpavea_gypjv9.webp",
          index: 4,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880378/galleryHighRes/phase1/electrical_discussion_qpavea.jpg"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477178/gallery/phase1/electrical_2_xv2vdj_ott2ks.webp",
          index: 5,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880379/galleryHighRes/phase1/electrical_2_xv2vdj.jpg"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477178/gallery/phase1/dining_room_discussion_wxmdwj_xru80v.webp",
          index: 6,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880378/galleryHighRes/phase1/dining_room_discussion_wxmdwj.jpg"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477178/gallery/phase1/circle_window_with_pendant_light_mbvjwj_xjqwft.webp",
          index: 7,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880377/galleryHighRes/phase1/circle_window_with_pendant_light_mbvjwj.jpg"
        }
      ],
      [
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477177/gallery/phase1/Humming_Bird_vwjffp_mblvnn.webp",
          index: 8,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880377/galleryHighRes/phase1/Humming_Bird_vwjffp.jpg"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477177/gallery/phase1/Framing_hqxw7y_sozqoy.webp",
          index: 9,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880380/galleryHighRes/phase1/Framing_hqxw7y.jpg"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477178/gallery/phase1/Bike_d1id7e_eef5ur.webp",
          index: 10,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880379/galleryHighRes/phase1/Bike_d1id7e.jpg"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477178/gallery/phase1/Amit_and_Russel_asulsg_aafvvy.webp",
          index: 11,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880380/galleryHighRes/phase1/Amit_and_Russel_asulsg.jpg"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635477178/gallery/phase1/2021.05.29_roof_2_cm4ouk_s3b7m1.webp",
          index: 12,
          raw: "https://res.cloudinary.com/dt4xntymn/image/upload/v1630880377/galleryHighRes/phase1/2021.05.29_roof_2_cm4ouk.jpg"
        }
      ]
    ],
    card: [
  ...
  "phase-2": {
    main: [
      [
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484631/gallery/phase2/31_s1vkyi.webp",
          index: 0,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484782/galleryHighRes/phase2/31_dd6j1c.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484636/gallery/phase2/30_tyvmfc.webp",
          index: 1,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484774/galleryHighRes/phase2/30_r1fsm3.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484649/gallery/phase2/29_yrgs05.webp",
          index: 2,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484747/galleryHighRes/phase2/29_elc7ro.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484621/gallery/phase2/28_lvljqa.webp",
          index: 3,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484753/galleryHighRes/phase2/28_kaymbm.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484625/gallery/phase2/27_w337cb.webp",
          index: 4,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484749/galleryHighRes/phase2/27_nbr2r9.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484628/gallery/phase2/26_nsydtl.webp",
          index: 5,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484778/galleryHighRes/phase2/26_vsd6pk.webp"
        }
      ],
      [
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484634/gallery/phase2/25_uy4zji.webp",
          index: 6,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484770/galleryHighRes/phase2/25_rn9hxq.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484650/gallery/phase2/24_upuaau.webp",
          index: 7,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484745/galleryHighRes/phase2/24_cf8u1p.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484620/gallery/phase2/23_vk15yj.webp",
          index: 8,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484804/galleryHighRes/phase2/23_fuoteu.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484630/gallery/phase2/22_nrbdcs.webp",
          index: 9,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484768/galleryHighRes/phase2/22_dnzbsi.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484626/gallery/phase2/21_mnvrce.webp",
          index: 10,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484757/galleryHighRes/phase2/21_mj77et.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484627/gallery/phase2/20_evitvx.webp",
          index: 11,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484755/galleryHighRes/phase2/20_r5wxvs.webp"
        }
      ],
      [
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484632/gallery/phase2/19_oho5nj.webp",
          index: 12,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484772/galleryHighRes/phase2/19_ymcgai.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484624/gallery/phase2/18_yowmxe.webp",
          index: 13,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484761/galleryHighRes/phase2/18_qol656.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484622/gallery/phase2/17_nkcnlg.webp",
          index: 14,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484764/galleryHighRes/phase2/17_ebiayc.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484629/gallery/phase2/16_waxrk7.webp",
          index: 15,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484759/galleryHighRes/phase2/16_mckquj.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484623/gallery/phase2/15_zmoq27.webp",
          index: 16,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484766/galleryHighRes/phase2/15_awffbd.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484643/gallery/phase2/0_djt0nt.webp",
          index: 17,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484794/galleryHighRes/phase2/0_filifv.webp"
        }
      ],
      [
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484645/gallery/phase2/09_xwy0b0.webp",
          index: 18,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484798/galleryHighRes/phase2/09_xhijw6.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484647/gallery/phase2/08_p41jbp.webp",
          index: 19,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484802/galleryHighRes/phase2/08_vjtqqd.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484640/gallery/phase2/07_d0zyle.webp",
          index: 20,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484788/galleryHighRes/phase2/07_tzf9ru.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484633/gallery/phase2/06_tsqrz5.webp",
          index: 21,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484776/galleryHighRes/phase2/06_thya3z.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484641/gallery/phase2/05_l9wvmr.webp",
          index: 22,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484796/galleryHighRes/phase2/05_cjoqkt.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484638/gallery/phase2/04_qica0p.webp",
          index: 23,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484786/galleryHighRes/phase2/04_n2hjco.webp"
        }
      ],
      [
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484644/gallery/phase2/03_e0bc95.webp",
          index: 24,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484800/galleryHighRes/phase2/03_fdtads.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484639/gallery/phase2/02_dakd9i.webp",
          index: 25,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484790/galleryHighRes/phase2/02_zoo1gz.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484619/gallery/phase2/014_zp6cb4.webp",
          index: 26,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484751/galleryHighRes/phase2/014_c6uslw.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484647/gallery/phase2/013_xto6rg.webp",
          index: 27,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484743/galleryHighRes/phase2/013_as3vph.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484637/gallery/phase2/012_b70rvv.webp",
          index: 28,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484784/galleryHighRes/phase2/012_rxrg36.webp"
        },
        {
          url: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484635/gallery/phase2/011_jjdq6u.webp",
          index: 29,
          raw: "http://res.cloudinary.com/dt4xntymn/image/upload/v1635484780/galleryHighRes/phase2/011_diomvr.webp"
        }
      ]
    ],
    card: [
...
const Gallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let selected;
  const phases = [
    { label: "phase 1", select: "phase-1" },
    { label: "phase 2", select: "phase-2" }
  ];
  $$result.css.add(css$8);
  $$unsubscribe_galleryImg();
  return `<div class="${"page"}"><div class="${"phase-label-container svelte-b6hwfi"}">${each(phases, (phase) => `<h5 class="${[
    "svelte-b6hwfi",
    phase.select === $galleryImg.currPhase ? "phase-label" : ""
  ].join(" ").trim()}">${escape(phase.label)}
      </h5>`)}</div>
  <div class="${"flex-container " + escape($galleryImg.currPhase) + " svelte-b6hwfi"}">${each(images[$galleryImg.currPhase].main, (col) => `<div class="${"flex-column svelte-b6hwfi"}">${each(col, (img, i) => `${validate_component(GallerySelected, "GallerySelected").$$render($$result, { img, selected }, {}, {})}`)}
      </div>`)}
...
const CardGallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div><div id="${"behind-the-scenes"}" class="${"container svelte-iyyz4g"}"><div><h5 class="${"bu-title bu-has-text-centered svelte-iyyz4g"}">behind the scenes</h5></div>
    <div class="${"curr-phase-container svelte-iyyz4g"}">${each(phases, (phase) => `<h5 class="${["svelte-iyyz4g", phase.select === currPhase ? "phase-label" : ""].join(" ").trim()}">${escape(phase.label)}
        </h5>`)}</div>
    <div class="${"gallery-container svelte-iyyz4g"}">${each(images[currPhase].card, (image, i) => `<div class="${"image-container svelte-iyyz4g"}"><img${add_attribute("src", image.url, 0)} loading="${"lazy"}" alt="${""}" class="${"svelte-iyyz4g"}">
        </div>`)}</div></div>
</div>`;
});
